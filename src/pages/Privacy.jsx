...
import { Link } from "react-router-dom"; // Import Link if you need to use it for navigation
      ...
      <div className="privacy-policy-page">
        ...
        <div className="privacy-content">
          ...
          <ul>
            ...
            <li>
              <p>
                <strong>Application</strong> refers to Beacon Consulting and
                Advisory LLC, the software program provided by the Company.
              </p>
            </li>
            <li>
              <p>
                ...
                in this Agreement) refers to Beacon Consulting and Advisory LLC,
                29 S. Bay Ave.
              </p>
            </li>
            <li>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Beacon Consulting and
                Advisory LLC, accessible from{" "}
                <a
                  href="http://beaconconsultingandadvisory.com"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  http://beaconconsultingandadvisory.com
                </a>
              </p>
            </li>
            <li>
          ...
          <ul>
            <li>
              ...
              <a
                href="http://beaconconsultingandadvisory.com/privacy"
                rel="external nofollow noopener"
                target="_blank"
              >
                http://beaconconsultingandadvisory.com/contact
              </a>
            </li>
          </ul>
        </div>
